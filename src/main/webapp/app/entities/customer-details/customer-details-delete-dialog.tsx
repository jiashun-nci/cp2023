...
export const CustomerDetailsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="storeApp.customerDetails.delete.question">
        <Translate contentKey="storeApp.customerDetails.delete.question" interpolate={{ id: customerDetailsEntity.id }}>
